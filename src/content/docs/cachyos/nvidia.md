...
That covers the driver. What's left is confirming it loaded, enrolling a Secure Boot key if you run Secure Boot, and one power setting that is specific to this laptop and is *not* set for you.
