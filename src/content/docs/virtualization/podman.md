...
next: docs/virtualization/distrobox
---
...
> See the [Development]({{< relref "/docs/applications/development#podman--podman-desktop" >}}) page in Applications for the short installation summary.
